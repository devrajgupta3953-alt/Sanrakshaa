...
<body class="bg-slate-50 h-screen w-full overflow-hidden select-none text-slate-800">
    ...
    <script type="text/babel">
        ...
        const TRANSLATIONS = {
            ...
            'Sanraksha': { hi: 'संरक्षा' },
            'Professional Care System': { hi: 'पेशेवर देखभाल प्रणाली' },
            'Secure Login': { hi: 'सुरक्षित लॉगिन' },
            'Mobile Number': { hi: 'मोबाइल नंबर' },
            'Login': { hi: 'लॉगिन' },
            'Synced': { hi: 'सिंक्ड' },
            'Offline': { hi: 'ऑफलाइन' },
            'Search patients...': { hi: 'मरीज खोजें...' },
            'Quick Actions': { hi: 'त्वरित कार्य' },
            
            // Dashboard Cards
            'Total Cases': { hi: 'कुल मामले' },
            'High Risk': { hi: 'हाई रिस्क' },
            'Anemic': { hi: 'एनीमिक' },
            'Recent Outcomes': { hi: 'हाल के परिणाम' },
            ...
            // Inventory
            'Medical Inventory': { hi: 'चिकित्सा भंडार' },
            'remaining': { hi: 'शेष' },
            'Low Stock': { hi: 'कम स्टॉक' },
            'Order Now': { hi: 'ऑर्डर करें' },
            'Ordered': { hi: 'ऑर्डर किया' },
            
            // Registration
            'New Registration': { hi: 'नया पंजीकरण' },
            'Single Source Data': { hi: 'एकल स्रोत डेटा' },
            ...
            'Village': { hi: 'गाँव' },
            'Vitals': { hi: 'वाइटल्स' },
            'Sync Device': { hi: 'सिंक डिवाइस' },
            'Save & Sync': { hi: 'सेव और सिंक' },
            
            // Patient Profile
            'Patient Profile': { hi: 'मरीज प्रोफाइल' },
            'Obstetric History': { hi: 'प्रसूति इतिहास' },
            'Counseling & Job Aids': { hi: 'काउंसलिंग और जॉब एड्स' },
            'Start Checkup': { hi: 'जांच शुरू करें' },
            'Emergency Referral': { hi: 'आपातकालीन रेफरल' },
            'Hemoglobin Trend (Weeks vs g/dL)': { hi: 'हीमोग्लोबिन ट्रेंड' },
            
            // Training
            'ASHA Academy': { hi: 'आशा अकादमी' },
            'Learn, Practice, and Master your skills.': { hi: 'सीखें, अभ्यास करें और निपुण बनें।' },
            'Learn': { hi: 'सीखें' },
            'ECHO Live': { hi: 'ईको लाइव' },
            'Sim Lab': { hi: 'सिम लैब' },
            'ECHO Hub': { hi: 'ईको हब' },
            'Daily Challenge': { hi: 'दैनिक चुनौती' },
            
            // Finance
            'Finance Hub': { hi: 'वित्त केंद्र' },
            'Track your earnings and benefits': { hi: 'अपनी कमाई और लाभ ट्रैक करें' },
            'Ledger': { hi: 'खाता' },
            'Salary': { hi: 'वेतन' },
            'Benefits': { hi: 'लाभ' },
            'Total Earnings': { hi: 'कुल कमाई' },
            'Fixed Honorarium': { hi: 'निश्चित मानदेय' },
            'Performance Incentives': { hi: 'प्रदर्शन प्रोत्साहन' },
            'Download Slip': { hi: 'स्लिप डाउनलोड करें' },
            
            // Safety
            'ASHA Sahayata (Safety)': { hi: 'आशा सहायता (सुरक्षा)' },
            'Safety Hub': { hi: 'सुरक्षा केंद्र' },
            'Your safety is our priority.': { hi: 'आपकी सुरक्षा हमारी प्राथमिकता है।' },
            'Emergency Dial': { hi: 'आपातकालीन कॉल' },
            'Women Line': { hi: 'महिला हेल्पलाइन' },
            'Med. Officer': { hi: 'चिकित्सा अधिकारी' },
            'Call Now': { hi: 'कॉल करें' },
            'Peer Network (Buddy System)': { hi: 'साथी नेटवर्क' },
            'Request Visit': { hi: 'मदद मांगें' },
            'Anonymous Reporting': { hi: 'गुमनाम रिपोर्टिंग' },
            'Submit Report': { hi: 'रिपोर्ट भेजें' },
            
            // Referral
            'Referral': { hi: 'रेफरल' },
            'High Risk Protocol Activated': { hi: 'हाई रिस्क प्रोटोकॉल सक्रिय' },
            'Referral ID': { hi: 'रेफरल आईडी' },
            'PHC Alerted': { hi: 'PHC सूचित' },
            'Back to Home': { hi: 'होम पर जाएं' },
            'Dispatch Confirmed (5 mins away)': { hi: 'डिस्पैच की पुष्टि (5 मिनट दूर)' },
            'Waiting...': { hi: 'प्रतीक्षा...' },
            'Connecting to network...': { hi: 'नेटवर्क से जुड़ रहा है...' },
            ...
            // Branding
            'National Health Mission': { hi: 'राष्ट्रीय स्वास्थ्य मिशन' },
            'Digital India': { hi: 'डिजिटल इंडिया' },
            
            // Sidebar
            'My Earnings & Benefits': { hi: 'मेरी कमाई और लाभ' },
            'Performance Report': { hi: 'प्रदर्शन रिपोर्ट' },
            'Settings': { hi: 'सेटिंग्स' },
            'Logout': { hi: 'लॉग आउट' },
            
            // Assessment
            'Save Assessment': { hi: 'आकलन सेव करें' },
            'Algorithm Recommendation': { hi: 'एल्गोरिदम सुझाव' },
            'Play Doctor\'s Message': { hi: 'डॉक्टर का संदेश सुनें' },

            // Login & Reset
            'Send OTP': { hi: 'OTP भेजें' },
            'Enter OTP': { hi: 'OTP दर्ज करें' },
            'Verify & Login': { hi: 'सत्यापित करें और लॉगिन करें' },
            'Forgot PIN?': { hi: 'पिन भूल गए?' },
            'Reset PIN': { hi: 'पिन रीसेट करें' },
            'New PIN': { hi: 'नया पिन' },
            'Reset Password': { hi: 'पासवर्ड रीसेट' },
            'Resend': { hi: 'पुनः भेजें' },
            'Confirm New PIN': { hi: 'नया पिन पुष्टि करें' },
            'Back to Login': { hi: 'लॉगिन पर वापस जाएं' },
            'ASHA ID': { hi: 'आशा आईडी' },
            'PIN': { hi: 'पिन' }
        };
        ...
        const SYMPTOM_CHECKLIST = [
            { id: 'anaemia_symptom', weight: 0, hi: 'क्या बहुत थकावट है? या सांस फूल रही है?', en: 'Extreme fatigue? Shortness of breath?', icon: '😫', guide: 'Ask: "Can you walk up stairs without stopping?"' },
            { id: 'edema', weight: RISK_WEIGHTS.EDEMA, hi: 'पैर, हाथ या चेहरे में सूजन है?', en: 'Swelling in feet, hands, or face?', icon: '🦶', guide: 'Action: Press thumb on shin bone for 5 seconds. If pit remains, select Yes.' },
            { id: 'htn', weight: RISK_WEIGHTS.HTN, hi: 'सिर में दर्द है? आँखों के सामने अंधेरा आता है?', en: 'Severe headache? Dark spots before eyes?', icon: '🤕', guide: 'Check BP immediately. If >140/90, select Yes.' },
            { id: 'bleeding', weight: RISK_WEIGHTS.BLEEDING, hi: 'क्या ब्लीडिंग या डिस्चार्ज हो रहा है?', en: 'Vaginal bleeding or discharge?', icon: '🩸', critical: true, guide: 'Ask about pad usage. Any soaking is critical.' },
            { id: 'pain', weight: RISK_WEIGHTS.PAIN, hi: 'पेट में तेज दर्द या ऐंठन है?', en: 'Severe abdominal pain or cramping?', icon: '🤰', guide: 'Touch abdomen. If hard or very tender, select Yes.' },
            { id: 'contractions', weight: RISK_WEIGHTS.CONTRACTIONS, hi: 'क्या रुक-रुक कर दर्द (contractions) हो रहा है?', en: 'Having regular contractions?', icon: '⏱️', critical: true, guide: 'Time it: More than 2 pains in 10 minutes?' },
            { id: 'fever', weight: RISK_WEIGHTS.FEVER, hi: 'बुखार है? पेशाब में जलन है?', en: 'Fever? Burning urination?', icon: '🌡️', guide: 'Check temperature with thermometer. Look for dark urine.' },
            { id: 'mental', weight: RISK_WEIGHTS.MENTAL, hi: 'क्या आप बहुत तनाव या अकेलापन महसूस कर रही हैं?', en: 'Feeling very stressed or alone?', icon: '🧠', guide: 'Observation: Is she crying or very silent? Ask about sleep.' }
        ];
        ...
        const INITIAL_NOTIFICATIONS = [
            ...
            { id: 2, type: 'credit', title: 'Incentive Credited', msg: '₹200 for Immunization (Rohan).', time: '1 hr ago' },
        ...
        const AskDidiModal = ({ isOpen, onClose, lang }) => {
            ...
            const simulateVoiceInput = () => {
                setIsListening(true);
                setTimeout(() => {
                    setQuery(lang === 'hi' ? "गर्भवती महिला को क्या खाना चाहिए?" : "What should a pregnant woman eat?");
                                ...
                                <div key={m.id} style={{animationDelay: `${i * 75}ms`}} onClick={() => { setSelectedMother(m); setScreen('patient_detail'); }} className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm mb-3 cursor-pointer flex justify-between items-center animate-in slide-in-from-bottom-2 fade-in duration-300 fill-mode-backwards hover:bg-slate-50 active:scale-[0.98] transition-transform">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-500">{m.weeks} {t('Weeks')} • {m.village}</p>
                                        </div>
                                    </div>
                                ...
                                {[{title: "PPH Management", type: "Video", min: "10"}, {title: "Neonatal Care", type: "Audio", min: "5"}, {title: "Hypertension", type: "Quiz", min: "15"}].map((m, i) => (
                                    <div key={i} className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm flex justify-between items-center">
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-500">{m.type} • {m.min} mins</p>
                                        </div>
                                ...
                                {ECHO_SESSIONS.map((s) => (
                                    <div key={s.id} className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
                                        <div className="flex justify-between items-start mb-2">
                                            <span className={`text-[10px] font-bold px-2 py-0.5 rounded uppercase ${s.status === 'live' ? 'bg-red-100 text-red-600 animate-pulse' : 'bg-slate-100 text-slate-500'}`}>{s.status === 'live' ? '● Live Now' : 'Upcoming'}</span>
                                ...
                                {FINANCE_DATA.ledger.map(item => (
                                    <div key={item.id} className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm flex justify-between items-center">
                                        ...
                                        <div className="text-right">
                                            <p className={`font-bold ${item.status === 'credited' ? 'text-emerald-600' : 'text-amber-600'}`}>₹{item.amount}</p>
                        ...
                        {financeTab === 'salary' && (
                            <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
                                <div className="text-center mb-6 border-b border-slate-100 pb-4">
                                    ...
                                    <h3 className="text-3xl font-bold text-slate-800 mt-1">₹{FINANCE_DATA.salary.total}</h3>
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="font-bold text-slate-800">₹{FINANCE_DATA.salary.honorarium}</span>
                                    </div>
                                    <div className="flex justify-between items-center text-sm">
                                        <span className="text-slate-600">{t('Performance Incentives')}</span>
                                        <span className="font-bold text-emerald-600">+ ₹{FINANCE_DATA.salary.incentives}</span>
                                    </div>
                                </div>
                                    ...
                                    <div key={peer.id} className="p-3 border-b border-slate-100 last:border-0 flex justify-between items-center">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] text-slate-500">{peer.distance} • {peer.status}</p>
                                            </div>
                                        </div>
                 ...
                 <div className="p-4 space-y-4 animate-in slide-in-from-left">
                    <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500">ASHA Worker • ID: ASH-101</p>
                        </div>
                    </div>
                    <div className="bg-white rounded-lg border border-slate-200 overflow-hidden">
                        {[
